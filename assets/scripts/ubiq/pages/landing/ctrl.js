...
angular.module('ubiq.controllers').controller('LandingPageCtrl', ($scope, envService) => {
  const ctrl = this

  ctrl.isMobile = envService.isMobile()
...
//   var ubiqBackgroundVideo = $('.uq-landing-video')
...
//     if (mobilecheck()){
//       ubiqBackgroundVideo.remove()
//       ubiqBackgroundMedia.addClass('uq-landing-video-container--mobile')
//     }
//   }
//
//   checkMobile()
